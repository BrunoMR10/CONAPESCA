...
public class CorrectivosRF extends AppCompatActivity implements View.OnClickListener {
    Datos dt = new Datos();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correctivos_rf);
    ...
    private void ActualizaEstadoReporte(){
        SharedPreferences sh = getSharedPreferences(Datos[1], MODE_PRIVATE);
    ...
    private  void CrearArchivo(){
        try {
            ...
            SharedPreferences.Editor myEdit = sh.edit();
            int ID = sh.getInt("ID", 1);
            correctivo.CreaRF(Datos,imageData,ID-1,ObtenComentarios());
